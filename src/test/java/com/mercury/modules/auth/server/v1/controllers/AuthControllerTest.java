...
import org.springframework.boot.autoconfigure.web.servlet.error.ErrorMvcAutoConfiguration; // Import ErrorMvcAutoConfiguration
...
class AuthControllerTest {
    ...
    void registerUser_withValidData_shouldReturnCreatedAndUserDTO() throws Exception {
        ...
        result.andExpect(status().isCreated())
                ...
                .andExpect(jsonPath("$.id").value(id.toString())) // Kein Cast nötig
                .andExpect(jsonPath("$.username").value(expectedUser.getUsername())) // Kein Cast nötig
                .andExpect(jsonPath("$.email").value(expectedUser.getEmail())); // Kein Cast nötig
    ...
    void registerUser_withInvalidData_shouldReturnBadRequest() throws Exception {
        var invalidInputDTO = new CreateUserDTO()
                .setUsername("test")
