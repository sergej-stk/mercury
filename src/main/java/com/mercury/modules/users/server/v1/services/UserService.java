...
public class UserService {
    ...
    /**
     * Generates a random string segment based on configured charset and length. This is used as
     * part of the unique display ID.
     *
    ...
    /**
     * Generates a unique display ID by combining a prefix and a random part. Retries generation
     * until a unique ID (not present in the database) is found.
     *
    ...
    private String generateUniqueDisplayId() {
        ...
        do {
            ...
            if (attempts > 1) {
                log.warn(
                        "Display ID collision detected. Retrying generation (attempt {})...",
                        attempts);
            }
        ...
        log.info(
                "Successfully generated unique display ID '{}' after {} attempt(s).",
                displayId,
                attempts);
        return displayId;
    }
    ...
    /**
     * Creates and persists a new user after validating username/email uniqueness. Generates a
     * unique display ID and encodes the password before saving. This operation is transactional.
     *
    ...
    public User createUser(CreateUserDTO createUserDTO) {
        ...
        log.debug(
                "Saving new user: username={}, displayId={}",
                result.getUsername(),
                result.getDisplayId());
