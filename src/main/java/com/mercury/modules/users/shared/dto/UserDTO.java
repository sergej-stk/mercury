...
@Schema(
        ...
        title = "User",
        description =
                "Represents a user with identifiers, core profile information (username, email),"
                    + " and system metadata. Suitable for API responses displaying user details.")
public class UserDTO {
    @Schema(
            title = "ID",
            description =
                    "A stable, unique identifier (UUID) used for referencing the user in public"
                        + " APIs or between systems. Not intended for direct display to end-users.",
